...
export function HomeComponent() {
  return (
    <Grid
      container
      spacing={0}
      sx={{ maxWidth: '1200px', margin: '0 auto', py: 6 }}
    >
      <Grid
        item
        xs={12}
      ...
      >
        ...
        <TitleTextComponent
          ...
          sx={{ textAlign: 'center', fontSize: '20px', color: '#707C87' }}
        />
        <BtnComponent
          className={
            'text-white font-roboto !font-medium bg-blue-800 !normal-case rounded !text-lg'
          }
